...
$( document ).ready(function() {
  if (typeof web3 !== 'undefined') {
    ...
    console.warn("No web3 detected. Falling back to http://localhost:8500 You should remove this fallback when you deploy live, as it's inherently insecure. Consider switching to Metamask for development. More info here: http://truffleframework.com/tutorials/truffle-and-metamask");
